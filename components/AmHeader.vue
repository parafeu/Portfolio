<template>
  <div id="header">
    ...
    <div class="animate__animated animate__fadeInDown animate__delay-1s mb-6">
      ...
      <hr />
      <h2>Développeur Web Frontend / Backend</h2>
    </div>

    <am-console
      title="Informations"
      v-model="windowStatus"
      class="animate__animated animate__fadeInLeft animate__delay-2s m-4"
      @close="closeWindow"
    >
      ...
      <h3 class="line2" :style="{ animationDelay: `${linesDelay + 1080}ms` }">
        📞 <a href="tel:+33613466802">0613466802</a>
      </h3>
      <br />
      <h3
        class="line3"
...
#header {
  ...
  h3 {
    ...
    &.line3 {
      ...
      .caret {
        @apply text-white absolute bottom-0 top-0 right-1 hidden md:inline leading-tight;
